        ...
        <table class="table table-bordered ml-3">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                 <a href="{{route('examination.show',$examination->id)}}" class="btn btn-primary"><i class="fas fa-info fa-1x"></i></a>
                <a href="{{route('examination.edit',$examination->id)}}" class="btn btn-warning"><i class="fas fa-edit fa-1x"></i></a>
